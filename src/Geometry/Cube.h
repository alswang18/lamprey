...
public:
    ...
    static IndexedTriangleList<V> MakeIndependent()
    {
        ...
        return {std::move(vertices),
                {0,  2,  1,  2,  3,  1,  4,  5,  7,
                 4,  7,  6,  8,  10, 9,  10, 11, 9,
                 12, 13, 15, 12, 15, 14, 16, 17, 18,
