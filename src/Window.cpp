                          ...
                          WPARAM wParam, LPARAM lParam)
{
    ...
    // (VK_MENU) and F10
    case WM_SYSKEYDOWN:
        // stifle this keyboard message if imgui wants to
        // capture
    ...
    case WM_MOUSEMOVE:
    {
        // stifle this mouse message if imgui wants to
        // capture
...
{
    return "Lamprey Window Exception";
}
...
{
    return "Lamprey Window Exception [No Graphics]";
}
